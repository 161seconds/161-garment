                ...
                <div class="card-body p-2">
                    ...
                    <form action="register" method="POST" id="registerForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-0 fw-semibold" id="fullName" name="fullName" placeholder="VD: Nguyễn Văn A" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="email" class="form-label fw-bold small text-uppercase">Địa chỉ Email <span class="text-danger">*</span></label>
                            <input type="email" class="form-control rounded-0 fw-semibold" id="email" name="email" placeholder="name@example.com" required>
                            <div class="form-text small text-muted">Dùng để nhận thông báo đơn hàng và đăng nhập.</div>
                        </div>
                        
                        <div class="mb-3">
                            <label for="phone" class="form-label fw-bold small text-uppercase">Số điện thoại <span class="text-danger">*</span></label>
                            <input type="tel" class="form-control rounded-0 fw-semibold" id="phone" name="phone" pattern="[0-9]{9,11}" placeholder="09xxxxxxxx" required>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div id="passError" class="text-danger small mt-1" style="display:none;">Mật khẩu xác nhận không khớp!</div>
                        </div>

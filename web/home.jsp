...
<div id="heroVideoCarousel" class="carousel slide carousel-fade position-relative w-100 overflow-hidden" data-bs-ride="carousel" data-bs-interval="12000" style="height: 85vh; min-height: 550px; max-height: 850px; background-color: #000; margin-top: 0;">
    <!-- Carousel Indicators (Uniqlo Minimalist Lines) -->
    <div class="carousel-indicators mb-4" style="z-index: 3;">
        <button type="button" data-bs-target="#heroVideoCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1" style="width: 35px; height: 3px; border-radius: 0;"></button>
        <button type="button" data-bs-target="#heroVideoCarousel" data-bs-slide-to="1" aria-label="Slide 2" style="width: 35px; height: 3px; border-radius: 0;"></button>
    </div>
    ...
    <div class="carousel-inner h-100">
        ...
        <div class="carousel-item active h-100 position-relative">
            <video autoplay loop muted playsinline class="w-100 h-100" style="object-fit: cover; object-position: center; display: block;">
                <source src="${pageContext.request.contextPath}/img-prj301/uniqlo-video.mp4" type="video/mp4">
                <source src="${pageContext.request.contextPath}/uniqlo-video.mp4" type="video/mp4">
                Trình duyệt của bạn không hỗ trợ video HTML5.
            </video>
            <!-- Bottom Left Overlay Slide 1 -->
            <div class="position-absolute bottom-0 start-0 p-4 p-md-5 text-white" style="z-index: 2; max-width: 650px; pointer-events: none;">
                <span class="badge bg-black text-white px-3 py-1 text-uppercase mb-3 rounded-pill fw-bold" style="font-size: 0.75rem; letter-spacing: 1px; border: 1px solid rgba(255,255,255,0.3); pointer-events: auto;">
                    TRENDING
                </span>
                <h1 class="fw-bold mb-2 text-uppercase text-white tracking-tight" style="font-size: 2.3rem; letter-spacing: 0.5px; text-shadow: 0 2px 8px rgba(0,0,0,0.8);">
                    Bí Mật là? Quần Ống Cong Barrel.
                </h1>
                <p class="fs-6 mb-0 text-white" style="text-shadow: 0 1px 6px rgba(0,0,0,0.9); line-height: 1.5; opacity: 0.95;">
        ...
        <div class="carousel-item h-100 position-relative">
            <video autoplay loop muted playsinline class="w-100 h-100" style="object-fit: cover; object-position: center; display: block;">
                <source src="${pageContext.request.contextPath}/img-prj301/uniqlo-video-02.mp4" type="video/mp4">
                <source src="${pageContext.request.contextPath}/uniqlo-video-02.mp4" type="video/mp4">
                Trình duyệt của bạn không hỗ trợ video HTML5.
            </video>
            <!-- Bottom Left Overlay Slide 2 -->
            <div class="position-absolute bottom-0 start-0 p-4 p-md-5 text-white" style="z-index: 2; max-width: 650px; pointer-events: none;">
                <span class="badge bg-danger text-white px-3 py-1 text-uppercase mb-3 rounded-pill fw-bold" style="font-size: 0.75rem; letter-spacing: 1px; pointer-events: auto;">
                    NEW COLLECTION
                </span>
                <h1 class="fw-bold mb-2 text-uppercase text-white tracking-tight" style="font-size: 2.3rem; letter-spacing: 0.5px; text-shadow: 0 2px 8px rgba(0,0,0,0.8);">
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#heroVideoCarousel" data-bs-slide="prev" style="width: 6%; z-index: 3;">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Trước</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#heroVideoCarousel" data-bs-slide="next" style="width: 6%; z-index: 3;">
...
<!-- Promo Strip -->
<div class="row g-2 mb-4 text-center small text-uppercase fw-bold text-muted border-top border-bottom py-2 bg-light">
    ...
    <div class="col-lg-3 col-md-4 mb-4">
        <div class="sticky-top" style="top: 80px; z-index: 10;">
            ...
            <div class="p-3 bg-light border text-center d-none d-md-block">
                ...
                <p class="small text-muted mb-2">Đăng ký thành viên để nhận ngay voucher giảm 10% cho đơn hàng đầu tiên!</p>
                <a href="register" class="btn btn-outline-dark btn-sm rounded-0 fw-bold w-100 text-uppercase">Đăng ký ngay</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-9 col-md-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
            ...
            <span class="small text-muted">
                Trang <strong>${currentPage != null ? currentPage : 1}</strong> / ${endPage != null && endPage > 0 ? endPage : 1}
            </span>
        </div>
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-xl-3 g-3 justify-content-center">
            <c:forEach var="p" items="${PRODUCTS}">
                <div class="col">
                    <div class="card h-100 border rounded-0 product-card bg-white position-relative">
                        <!-- Product Image -->
                        <a href="product?action=detail&id=${p.productID}" class="text-decoration-none d-block overflow-hidden">
                            <div class="image-wrapper text-center p-3" style="background-color: #F8F8F8; height: 260px; display: flex; align-items: center; justify-content: center;">
                        ...
                        <div class="card-body p-3 d-flex flex-column">
                            <span class="text-muted small text-uppercase" style="font-size: 0.7rem; letter-spacing: 0.5px;">161 Essentials</span>
                            <h6 class="card-title fw-bold fs-6 mb-1 text-truncate mt-1">
                                <a href="product?action=detail&id=${p.productID}" class="text-dark text-decoration-none">${p.name}</a>
                            </h6>
                            <p class="card-text text-muted small mb-3 text-truncate" style="font-size: 0.8rem;">${p.description}</p>
            ...
            <c:if test="${empty PRODUCTS}">
                <div class="col-12 py-5 text-center my-4 border">
                    ...
                    <p class="small text-muted mb-3">Vui lòng thử chọn danh mục khác hoặc quay lại sau.</p>
        ...
        <!-- Pagination -->
        <c:if test="${endPage > 1}">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mt-5 pb-3">
                ...
                <form action="product" method="GET" class="d-flex align-items-center gap-2 small">
                    ...
                    <button type="submit" class="btn btn-dark btn-sm rounded-0 fw-bold px-2 py-1" style="font-size: 0.8rem;">
                        GO
                    </button>
                </form>
            </div>
